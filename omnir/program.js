...
fs.readFile('./omnio/output.txt', 'utf8', function(err, content) {
  ...
  fs.writeFile('./omnio/result.txt', evaluatedArr, function(err, content) {
    if (err) throw console.error('Error writing evaluation', err);
    console.log('It\'s evaluated in /omnio/result.txt!')
  })
})
